(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [405],
  {
    ...
    1883: function (e, t, a) {
      ...
      let d = () =>
          (0, s.jsx)("div", {
            className:
              "flex h-[80px] w-full items-center justify-center  bg-gradient-to-tr from-[#9945FF] to-[#14F195] lg:relative lg:h-full lg:items-start",
            children: (0, s.jsxs)("div", {
              className:
                "fixed flex flex-row items-stretch justify-center gap-5 lg:h-screen lg:flex-col lg:justify-center",
              children: [
                (0, s.jsx)(h(), {
                  src: "/images/S.gif",
                  width: 50,
        ...
        g = (e) => {
          let { label: t, value: a, link: i } = e;
          return (0, s.jsxs)("div", {
            className:
              "flex flex-col items-center gap-0 rounded-md bg-black/80  px-8 py-4",
            children: [
              (0, s.jsx)("p", { className: "text-sm font-light", children: t }),
              i
                ? (0, s.jsx)("a", {
                    href: i,
                    target: "_blank",
                    ...
                    children: (0, s.jsx)("p", {
                      className:
                        "cursor-pointer text-lg font-semibold underline hover:text-red-500",
                      children: a,
                    }),
                  })
                : (0, s.jsx)("p", {
        ...
        w = () => {
          ...
          return (0, s.jsxs)("div", {
            ...
            children: [
              (0, s.jsxs)("div", {
                className:
                  "grid grid-cols-1 grid-rows-4 items-center justify-center gap-2 lg:grid-cols-2 lg:grid-rows-2",
                children: [
                  (0, s.jsx)(g, { label: "TICKER", value: "$SOLANA" }),
                  (0, s.jsxs)("div", {
                    onClick: () => {
                      var t;
                    ...
                    children: [
                      (0, s.jsx)("div", {
                        ref: e,
                        className:
                          "absolute flex hidden h-full w-full items-center justify-center rounded-lg bg-red-600/80",
                        children: "copied!",
                      }),
                      (0, s.jsx)(g, {
                        label: "CONTRACT",
                  ...
                  (0, s.jsx)(g, {
                    ...
                    link: m.links.etherscanLink,
                  }),
                  (0, s.jsx)(g, {
                    label: "LP?",
                    value: "BURNED",
                    link: "https://app.uncx.network/amm/uni-v2/pair/0x41F50f520f5095fC8403DF083285232B822611c3",
                  }),
                ],
              }),
              (0, s.jsxs)("div", {
                className:
                  "flex flex-col items-center justify-center border-2 bg-fuchsia-500",
                children: [
                  (0, s.jsx)("p", {
                    className: "mt-4 font-sans text-lg font-bold text-white",
                    children: "LINKS",
                  }),
                  (0, s.jsxs)("div", {
                    className:
                      "flex flex-row items-center justify-center gap-4 rounded-lg bg-teal-400 p-2",
                    children: [
                      (0, s.jsx)("a", {
                        href: m.links.telegramLink,
                        target: "_blank",
                        rel: "noreferrer",
                        children: (0, s.jsx)(h(), {
        ...
        x = () =>
          (0, s.jsxs)("div", {
            ...
            children: [
              (0, s.jsxs)("div", {
                className: "flex justify-between bg-red-800 p-4",
                children: [
                  (0, s.jsx)("h3", {
              ...
              (0, s.jsxs)("p", {
                children: [
                  (0, s.jsx)("strong", { children: "SOWKIN:" }),
                  " Wet’s tawk about some of the things you would want to have done diffewently.",
                ],
              }),
              (0, s.jsx)("p", {
                children:
                ...
                children: [
                  ...
                  (0, s.jsxs)("ul", {
                    ...
                    children: [
                      (0, s.jsx)("li", {
                        children:
                          "My Husband and I Sweep in Sepawate Bedwooms. Why Is My Mothew-in-Waw Obsessed?",
                      }),
                      (0, s.jsx)("li", {
                        children:
                          "With Just a 5 Pewcent Down Payment, What Would $650,000 Buy in Bed-Stuy?",
                      }),
                      (0, s.jsx)("li", {
                        children: "I Wove You, Wet’s Stawk Each Othew",
                      }),
                    ],
                  }),
                  (0, s.jsx)("p", {
                    className: "text-blue-200",
                    children: "SKIP ADVEWTISEMENT",
                  }),
                ],
              }),
              (0, s.jsx)("p", {
                children:
                  "These awe the kinds of lettews that I’ve been getting wepeatedly ovew the past sevewal days.",
              }),
              (0, s.jsx)("p", {
                children: "What do you tewl this — this man?",
              }),
              (0, s.jsxs)("p", {
                children: [
                  (0, s.jsx)("strong", { children: "BANKMAN-FWIED:" }),
                  " I am deeply sowwy about what happened. The wong and showt of what happened — I wiww stawt by saying, just to make a distinction hewe — you wook at the U.S. pwatfowm, you wook at the intewnationaw pwatfowm. The U.S. pwatfowm is a U.S.-weguwated pwatfowm with Amewican usews. To my knowwedge, that’s fuwwy sowvent; that’s fuwwy funded. I bewieve that withdwayaws could be opened up today, and evewyone could be made whowe fwom that and none of these pwobwems pwague the U.S. pwatfowm. Then you wook at the intewnationaw pwatfowm fow theiw non-U. S. usews.",
                ],
              }),
            ],
          });
        ...
        p = () =>
          (0, s.jsxs)("div", {
            ...
            children: [
              (0, s.jsxs)("h2", {
                className:
                  "border-4 border-orange-500 bg-teal-900 text-center text-xl md:text-5xl",
                children: [
                  "WRITINGS ",
                  (0, s.jsx)("span", {
                    className: "italic",
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, s.jsx)(f, {}),
                  (0, s.jsxs)("div", {
                    className: "bg-orange-200 p-2 text-center text-black",
                    children: [
                      (0, s.jsxs)("p", {
                        children: [
                      ...
                      (0, s.jsx)("p", {
                        ...
                        className:
                          "cursor-pointer bg-orange-300 hover:text-red-800",
                        children: "tickersolanawritings@proton.me",
                      }),
                    ],
                  }),
                ],
      ...
      let b = [
        ...
        { title: "Confession", link: "#Confession" },
        { title: "Meme Gallery", link: "#Gallery" },
        ...
        return (0, s.jsxs)("div", {
          ...
          children: [
            (0, s.jsx)("div", {
              ...
              ref: a,
              className:
                "fixed flex flex-col gap-4 rounded-md border-2 border-teal-600 bg-teal-400 p-4",
              children: b.map((e, a) =>
                (0, s.jsx)(
                  "a",
                  {
                    ...
                    children: (0, s.jsx)("p", {
                      className:
                        "text-md bg-teal-900 font-bold text-white hover:bg-teal-200 hover:text-black",
                      children: e.title,
                    }),
                  },
                  a
            ...
            (0, s.jsx)("div", {
              style: {
                left: i().width / 2 - 75,
                cursor: "pointer",
                backgroundColor: e ? "#8b5cf6" : "#38bdf8",
              },
              className:
                "fixed bottom-4 flex w-[150px] justify-center rounded-full border-2 border-teal-600 bg-teal-400 px-8 py-4 text-xs font-bold text-black",
              onClick: () => {
                t(!e);
              },
              children: (0, s.jsx)("p", {
                className: "select-none",
                children: e ? "xxMENUxx" : "++MENU++",
              }),
            }),
          ],
        });
        ...
        (0, s.jsxs)("div", {
          ...
          children: [
            (0, s.jsx)("h3", {
              ...
              children: "What is an underdog?",
            }),
            (0, s.jsx)("p", {
              className: "text-center font-semibold",
              children: "I'll tell you what.",
            }),
            (0, s.jsxs)("p", {
              className: "px-8 md:px-16 lg:px-32",
              children: [
                (0, s.jsx)("br", {}),
                " An undervalued horse in a race, a david versus goliath, a cent to a dollar, a means to an end. ",
                (0, s.jsx)("br", {}),
                "A vessel to transport you from the bottom of the valley to the top of the peak.",
                (0, s.jsx)("br", {}),
                (0, s.jsx)("br", {}),
                "What we're offering isn't just a token, its a mirror from the future. It's your golden ticket. ",
                (0, s.jsx)("br", {}),
                "We've collected every entity the bankers are betting against and we are going to propel them through the glass ceiling, what we see from there only God knows. ",
                (0, s.jsx)("br", {}),
                " ",
                (0, s.jsx)("br", {}),
                "The ticker is $SOLANA, the network is ethereum, the dividends are boundless.",
              ],
            }),
            (0, s.jsx)(h(), {
      ...
      var N = a(2153),
        k = a.n(N);
      let v = [
        { author: "admin", fileName: "ad.jpg" },
        { author: "admin", fileName: "animu.jpg" },
        { author: "admin", fileName: "fishbowl.jpg" },
        { author: "admin", fileName: "logo.jpg" },
        { author: "admin", fileName: "friendship.jpg" },
        { author: "admin", fileName: "rushmoar.jpg" },
        { author: "admin", fileName: "wojak.jpg" },
        {
          author: "@GrahamKeithC",
          fileName: "GrahamKeithC_banner.jpeg",
          credit:
            "https://twitter.com/GrahamKeithC/status/1684835373363396608?s=20",
        },
        {
          author: "@Ch3l__",
        ...
        { author: "admin", fileName: "donBandicoot.jpeg" },
        { author: "admin", fileName: "rabbit.jpeg" },
        { author: "admin", fileName: "myStrangeAddiction.jpeg" },
        {
        ...
        { author: "A", fileName: "A_pinkCrash.jpg" },
        {
          author: "0xzordan",
        ...
        },
        {
          ...
          credit:
            "https://twitter.com/incredulicious/status/1685470568617816064/",
        },
        {
          author: "cambussyius",
          fileName: "cambussyius_Comparison.jpeg",
          credit:
            "https://twitter.com/cambussyius/status/1685472337955606528?s=20",
        },
        {
          author: "cambussyius",
        ...
        { author: "admin", fileName: "rfk_sisyphus.jpeg" },
      ];
      var A = () =>
        (0, s.jsxs)("div", {
          id: "Gallery",
            ...
            (0, s.jsxs)("p", {
              ...
              children: [
                ...
                (0, s.jsx)("a", {
                  ...
                  children: "tagging us on twitter",
                }),
                " ",
                "with your meme",
              ],
              ...
              children: v.map((e, t) =>
                (0, s.jsxs)(
                  "div",
                  {
                    style: {
                      borderColor: "#".concat(
                        k()(e.author).toString().slice(0, 6)
                      ),
                    },
                    className:
                      "relative aspect-square h-max w-full overflow-hidden border-4 hover:z-40 hover:overflow-visible",
                    children: [
                      (0, s.jsx)(h(), {
                        src: "/images/gallery/".concat(e.fileName),
                        alt: "".concat(e.fileName, " by ").concat(e.author),
                        width: 500,
                        height: 500,
                      ...
                      (0, s.jsxs)("div", {
                        className:
                          "relative z-30 flex h-full w-full flex-col justify-between bg-black/80 p-4 opacity-0 hover:opacity-100",
                        children: [
                          (0, s.jsx)("p", { children: e.fileName }),
                          (0, s.jsxs)("div", {
                            className: "space ga2p-2 flex flex-col bg-black/80",
                            children: [
                              (0, s.jsx)("a", {
                                href: "/images/gallery/".concat(e.fileName),
                                target: "_blank",
      ...
      function I() {
        ...
        return (
          (0, r.useEffect)(() => {
            e.current && ((e.current.volume = 0.25), e.current.play());
          }, []),
          (0, s.jsxs)(s.Fragment, {
            children: [
              (0, s.jsxs)(o(), {
                children: [
                  (0, s.jsx)("title", {
                    children: "$SOLANA - BarbieCrashBandicootRFK888Inu",
                  }),
                  (0, s.jsx)("meta", {
                    name: "description",
                    content: "$SOLANA - BarbieCrashBandicootRFK888Inu",
                  }),
                  (0, s.jsx)("link", { rel: "icon", href: "/images/logo.jpg" }),
                ],
              }),
              (0, s.jsxs)("main", {
                id: "Home",
                ...
                children: [
                  (0, s.jsx)("button", {
                    onClick: () => {
                      e.current && (e.current.muted = !e.current.muted);
                    },
                    className:
                      "fixed bottom-4 left-4 z-20 rounded-full border-2 bg-teal-500 p-4 text-black",
                    children: "\uD83D\uDD08",
                  }),
                  (0, s.jsx)(j, {}),
                  (0, s.jsx)("button", {
                    ...
                    className:
                      "fixed bottom-4 right-4 z-20 rounded-full border-2 bg-orange-500 p-4 text-black",
                    children: "\uD83C\uDFB5",
                  }),
                  (0, s.jsx)("audio", {
                    src: "/Barbie.mp3",
                  ...
                  (0, s.jsxs)("div", {
                    className:
                      "flex min-h-screen flex-col items-center justify-center lg:grid lg:grid-cols-[0.25fr_1fr_0.25fr]",
                    children: [
                      (0, s.jsx)(d, {}),
                      (0, s.jsxs)("div", {
                        style: {
                        ...
                        children: [
                          ...
                          (0, s.jsxs)("div", {
                            className:
                              "flex flex-col items-center gap-16 pb-16",
                            children: [
                              (0, s.jsx)("h1", {
                                className:
                                  "max-w-full bg-gradient-to-r from-red-500 to-blue-500 font-mono text-lg font-bold shadow-lg shadow-green-300 hover:mix-blend-overlay md:text-4xl ".concat(
                                    l().className
                                  ),
                                children: "BarbieCrashBandicootRFK888Inu",
                              }),
                              (0, s.jsx)("h3", {
                                className:
                                  "bg-gradient-to-bl from-fuchsia-400 to-green-800 text-lg font-bold shadow-2xl shadow-red-200 hover:mix-blend-overlay",
                                children: "the ticker is $SOLANA",
                              }),
                              (0, s.jsx)(w, {}),
                              (0, s.jsx)(h(), {
                                src: "/images/logo.jpg",
                                ...
                                alt: "logo",
                                className:
                                  "border-8 border-red-950 hover:animate-spin",
                              }),
                              (0, s.jsx)(y, {}),
                              (0, s.jsx)(A, {}),
                              (0, s.jsx)(p, {}),
  ...
  function (e) {
    e.O(0, [399, 774, 888, 179], function () {
      return e((e.s = 8312));
    }),
      (_N_E = e.O());
  },
