  ...
  [179],
  {
      ...
      let n = r(2387),
        a = function (e) {
          for (
            ...
            a[o - 1] = arguments[o];
          return (0, n.normalizePathTrailingSlash)(r(2721).addLocale(e, ...a));
        };
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    2249: function (e, t, r) {
      ...
      let n = function () {
        for (var e = arguments.length, t = Array(e), n = 0; n < e; n++)
          t[n] = arguments[n];
        return r(8391).detectDomainLocale(...t);
      };
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
    ...
    5274: function (e, t, r) {
      ...
      async function K(e) {
        ...
        {
          let { normalizeLocalePath: e } = r(4842),
            { detectDomainLocale: t } = r(8391),
            { parseRelativeUrl: n } = r(3460),
            { formatUrl: i } = r(1410);
          if (a.locales) {
            let r = n(o),
    ...
    5932: function (e, t, r) {
      ...
      class X {
        ...
        async change(e, t, r, n, a) {
          ...
          {
            ($.locale =
              !1 === n.locale ? this.defaultLocale : n.locale || $.locale),
            ...
            let o = !1;
            (null == (f = this.locales) ? void 0 : f.includes($.locale)) ||
              ((e.pathname = (0, v.addLocale)(e.pathname, $.locale)),
          ...
          if (
            ...
            return G({ url: r, router: this }), !1;
          (ei = (0, P.removeLocale)((0, w.removeBasePath)(ei), $.locale)),
          ...
          try {
            ...
            if ((o.__N_SSG || o.__N_SSP) && o.props) {
              ...
              if (
                (($.isPreview = !!o.props.__N_PREVIEW), o.props.notFound === F)
              ) {
                let e;
                try {
            ...
            let _ =
              z && !d && !Y && !er && (0, x.compareRouterStates)(y, this.state);
            if (!_) {
              try {
                await this.set(y, o, d);
              } catch (e) {
        ...
        async getRouteInfo(e) {
          ...
          try {
            ...
            return (
              R.__N_SSP && j.dataHref && L && delete this.sdc[L],
              this.isPreview ||
                !R.__N_SSG ||
                p ||
                q(
